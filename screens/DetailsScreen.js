  ...
  const fetchReadme = async () => {
    ...
    try {
      ...
      const processedHTML = response.data
        .replace(
          /<img([^>]*)(>)/g,
          `<img$1 style="max-width: 100%; height: auto; display: block; margin: 10px 0;" $2`
        )
        .replace(
          /<table/g,
        ...
        .replace(
          /<pre>/g,
          '<pre style="background-color: #f6f8fa; border-radius: 6px; padding: 16px; overflow-x: auto; font-size: 14px; line-height: 1.45; white-space: pre-wrap; word-break: normal;">'
        )
        .replace(
          /<h1/g,
          '<h1 style="margin-top: 24px; margin-bottom: 16px; border-bottom: 1px solid #eaecef; padding-bottom: 0.3em;"'
        )
        .replace(
          /<h2/g,
          '<h2 style="margin-top: 24px; margin-bottom: 16px; border-bottom: 1px solid #eaecef; padding-bottom: 0.3em;"'
        );
            ...
            >
              {readmeContent ? (
                <>
                  ...
                  />
                  {!expanded && <View style={styles.readmeGradient} />}
                </>
              ) : (
                <View style={styles.noReadmeContainer}>
                  <Ionicons
                    ...
                    color="#bdc3c7"
                  />
                  <Text style={styles.noReadmeText}>
